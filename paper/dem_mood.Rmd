...
- Frederick Solt
  # affiliation: University of Iowa
anonymous: true  
abstract: "Prominent recent work, Claassen (2020a), argues that public support for democracy behaves thermostatically, that is, that declines in democracy prompt increases in democratic support and, conversely, that deepening democracy yields public backlash.  This work further contends that the classic theory that democracy itself increases democratic support over time is not supported by the evidence. Here, we document how these conclusions depend entirely on researcher degrees of freedom, in particular, a set of choices made early in the data collection process with regard to coding rules and the treatment of survey non-responses.  Looking across sixteen possible combinations of reasonable choices, we demonstrate that analyses employing these alternatives provide little or no support for the conclusions drawn in that article. The fragility of the published results to alternate reasonable choices both demonstrates the importance of taking degrees of researcher freedom seriously and suggests that those who value democracy should respond to threats of its erosion with a robust defense and indeed a push for democratic deepening rather than indulging in self-satisfied complacency."
keywords: ""

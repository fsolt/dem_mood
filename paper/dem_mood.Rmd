...
- Frederick Solt
  # affiliation: University of Iowa
anonymous: true  
abstract: "Prominent recent work argues that support for democracy behaves thermostatically---that democratic erosion boosts democratic support while deepening democracy yields public backlash---and further contends that there is no evidence for the classic argument that democracy itself increases democratic support over time.  Here, we document how these conclusions can substantively vary with subtle changes in measurement coding (a type of "researcher degree of freedom"): analyses employing alternative reasonable choices provide little or no support for the original conclusions. The fragility of the statistical results demonstrates that researcher degrees of freedom on measurement operation must be taken seriously and suggests that the relationship between democratic institution and democratic mood remain open for further explorations."
keywords: ""
...
Here, we illustrate the importance to take seriously of the researcher degree of freedom by replicating the primary analyses of @Claassen2020b but with varying two aspects of measurement operations.
...
The fragility of the published results to alternate reasonable choices demonstrates the importance of taking researcher degree of freedom seriously and suggests that it may be still too early to make a conclusion on the influence of the institutional development on democratic support.

...
Here, we highlight two researcher degrees of freedom in the evidence supporting a thermostatic response to democratic change.
The first is the manner in which ordinal survey responses were coded as supportive or not supportive of democracy.
The second is the attitude ascribed to survey respondents who did not answer items on dem
...
The second choice involves how to treat missing responses, that is, when survey respondents either answer that they "don't know" or simply refuse to answer the question.
...
One possibility not considered in the specification adopted in @Claassen2020b is that rising economic inequality undermines support for democratic institutions [@Magalhaes2014, 84; see also @Solt2012].
This and other theories of democratic support warrant further investigation.

Regardless, the fragility of the @Claassen2020b findings documented above has profound implications.
...
To the contrary, it is those who attempt to deepen democracy who pose the threat, as "extending democratic rights and legal protections to minorities" will trigger a public backlash against democracy [@Claassen2020b, 51].
...
That the evidence for such a perverse outcome depends entirely on researcher degrees of freedom suggests that defending democracy requires taking a very different course.
...
These findings imply that those who seek to advance democracy should do just that: they should push ahead.

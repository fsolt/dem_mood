...
For instance, we found in @Claassen2020b that the author coded the option "Necesitamos un líder fuerte que no tenga que ser elegid" as "strong_lapop_2" for the questio:n 
...
For examples, when recoding "evdemoc_asiab" in the Asian Barometer, @Claassen2020b counted the midpoint of its three-point scale as a positive, democracy-supporting response.
The coding results in substantial overreports in 35 country-years.
Similarly, in the second wave of the Asian Barometer, the study counts 5 along with 6 through 10 as positive responses.
...
The comparison witnesses a large amount of data from various surveys were underreported and a fair amount of data (mainly from the Asian barometers) were overreported.

...
Correcting these mistakes led the corrected analysis dataset to encompass a slightly different sample than in @Claassen2020b as the actual first observed year for several countries was earlier or later than recorded in the published data.
]
...
Second, __use the double-entry method__: when manual data entry can\emph{not} be avoided, each entry should be made twice.

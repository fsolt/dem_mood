...
- Frederick Solt
  # affiliation: University of Iowa
anonymous: true  
abstract: "Prominent recent work argues that support for democracy behaves thermostatically---that democratic erosion boosts democratic support while deepening democracy yields public backlash---and further contends that there is no evidence for the classic argument that democracy itself increases democratic support over time.  Here, we document how these conclusions depend entirely on researcher degrees of freedom: analyses employing alternative reasonable choices provide little or no support for the conclusions drawn in that article.  The fragility of the published results demonstrates that degrees of researcher freedom must be taken seriously and suggests that those who value democracy should respond to its threatened erosion with not complacency but instead a robust defense and a push for further democratic deepening."
keywords: ""

...
title: |
  ...
  | The Case of Thermostatic Democratic Support
...
tx_note <- str_wrap(
    c(
      " Sources: Publication data from Claassen (2020a); corrected data collected from original surveys.  Asia Barometer's item on the evaluation of democracy accounts for most overreports, and the Pew Global Attitude's item on the importance of democracy accounts for most large underreports.  In both cases, these problems can be attributed to errors in transcribing the data."
    ),
    width = 150
  )
...
```{r regressionPlot, fig.cap= "The Effect of Democracy on Change in Public Support with Uncertainty", fig.width=7, fig.height=10, eval=FALSE}

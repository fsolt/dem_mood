...
Before elaborating on our discovery, it is noteworthy that it is difficult to exactly tell the exact motivation based on the data outcomes.
The data-entry errors we identified may be alternatively because of coding mistake or intentional decisions. 
What we intend to present is that, such suspicious operations can cause critical consequence in empirical inferences.
As @JanzFreese2021[p.306] pointed out, a qualified scientific inquiry should "reflect on typical robustness challenges" on the substantive conclusions.
This is also a primary goal of this research.
